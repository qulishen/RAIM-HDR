...
class InputProj(nn.Module):
    def __init__(self, in_channel=3, out_channel=64, kernel_size=3, stride=1, norm_layer=None,act_layer=nn.LeakyReLU):
        ...
        self.proj = nn.Sequential(
            nn.Conv2d(in_channel, out_channel*5, kernel_size=3, stride=stride, padding=kernel_size//2, groups=in_channel//3),
            nn.Conv2d(out_channel*5, out_channel, kernel_size=1, stride=1, padding=0),
...
class Uformer(nn.Module):
    def __init__(self, img_size=512, img_ch=3,output_ch=3,
